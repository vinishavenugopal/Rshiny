...
regions=c("med","lat")
metadata<-as.data.frame(read_csv("C:/Users/vinisha/Documents/metadata_labdefined_net.csv"))
met<-metadata[c("ExternalSampleId","Sex","Site of Motor Onset","Age at Death","Sample Source","Final Subject Group - Bowser lab defined")]
...
server <- function(input,output,session)
{
  ...
  data <- reactive({
    ...
    if (dataset == "med")
      db = as.data.frame(read_csv("C:/Users/vinisha/Documents/txi_medial_result_net.csv"))
    else
      db = as.data.frame(read_csv("C:/Users/vinisha/Documents/txi_lateral_result_net.csv"))
  })
